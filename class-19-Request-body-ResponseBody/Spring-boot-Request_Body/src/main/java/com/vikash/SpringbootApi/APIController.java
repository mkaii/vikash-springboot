...
public class APIController {
  ...
  @GetMapping("student")
  public Student getStudent(@RequestBody Student s1){// s1 is ponting to the Student object
      System.out.println(s1.toString());  // to print content of the object we need to string and overide the method
      return s1; // just returning variables
  }
