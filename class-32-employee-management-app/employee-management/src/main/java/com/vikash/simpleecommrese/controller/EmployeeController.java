...
public class EmployeeController {
    ...
    // get employees based on category
    ...
    public String updateSalaryByGender(@PathVariable IncreasOrDeacrease increasOrDeacrease, Gender gender, @PathVariable float salary){
